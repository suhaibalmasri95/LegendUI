...
export class MenuDetailsService {
  ...
  add(system: System) {
    return this.http.post(this.apiUrl + 'Create', system).map(
      (response) => {
        return response;
      }
    );
  ...
  update(system: System) {
    return this.http.post(this.apiUrl + 'Update', system).map(
      (response) => {
        return response;
      }
    );
  ...
  delete(system: System) {
    return this.http.post(this.apiUrl + 'Delete', system).map(
      (response) => {
        return response;
      }
    );
